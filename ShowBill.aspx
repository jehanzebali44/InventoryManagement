<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowBill.aspx.cs" Inherits="InventoryManagementByWebForm.ShowBill" %>
            ...
            <div id="page-inner">
			 <div class="row">
                 ...
                 <form runat="server">
                     ...
                     <div class="col-md-12">
                         <asp:Button ID="Button1" runat="server" Text="Ok" class="btn btn-default"  OnClick="Button1_Click"/>
                 </div>
                     </form>
